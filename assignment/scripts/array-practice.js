...
let foodArray = ['burger', 'bacon', 'salmon', 'tacos'];

// 1.b. TODO: Log your array of foods to the console with a message, similar
//      to the example above
console.log('Foods are:', foodArray);
...
foodArray.push('chipotle');
console.log('Added a food item to end', foodArray);
...
console.log('Added a food item to beginning: ' + foodArray);
